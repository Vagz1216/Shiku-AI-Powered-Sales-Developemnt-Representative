...
*   **Planned Integrations**: Upcoming migration to AWS Aurora Serverless v2 (PostgreSQL) and a dedicated Next.js frontend.
...
*   `main.py`: FastAPI app and current Gradio mount (Frontend transition to Next.js planned)
...
*   `implementation.md`: The master checklist and architectural blueprint for the project
