    ...
    state = _sign_state(
        {
            ...
            "signature_enabled": bool(data.get("signature_enabled")),
...
def complete_authorization(
    *,
    ...
    mailbox = _upsert_oauth_mailbox(
        ...
        signature_enabled=bool(payload.get("signature_enabled")),
    ...
    with get_conn() as conn:
        with conn:
            ...
            if existing:
                ...
                conn.execute(
                    "UPDATE mailbox_connections SET provider = ?, display_name = ?, sender_display_name = ?, company_display_name = ?, "
                    "signature_enabled = ?, signature_text = ?, signature_html = ?, email_address = ?, status = 'CONNECTED', "
